...
namespace Client 
{
    sealed class RunSubmachineResolveShootSystem : IEcsRunSystem
    {
        readonly EcsWorldInject _world = default;
        readonly EcsSharedInject<BattleState> _state = default;
        readonly EcsFilterInject<Inc<RequestShootEvent, SubmachineComponent, WeaponComponent, RapidfireComponent, SpreadComponent>, Exc<InFiretickState>> _filterWeapon = default;
        ...
        public void Run(IEcsSystems systems)
        {
            ...
            { 
                ...
                for (global::System.Int32 i = 0; i < requestComp.ShotCount; i++)
                {
                    ...
                    _nearPool.Value.Add(missileEntity).Bonus = 0.25f;
