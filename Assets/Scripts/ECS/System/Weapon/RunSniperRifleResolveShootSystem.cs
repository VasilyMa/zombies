...
namespace Client 
{
    sealed class RunSniperRifleResolveShootSystem : IEcsRunSystem 
    {

        readonly EcsWorldInject _world = default;
        readonly EcsSharedInject<BattleState> _state = default;
        readonly EcsFilterInject<Inc<RequestShootEvent, SniperRifleComponent, WeaponComponent, RapidfireComponent, SpreadComponent>, Exc<InFiretickState>> _filterWeapon = default;
        ...
        public void Run(IEcsSystems systems)
        {
            ...
            { 
                ...
                for (global::System.Int32 i = 0; i < requestComp.ShotCount; i++)
                {
                    ...
                    ref var sniperBulletComp = ref _sniperPool.Value.Add(missileEntity);
                    sniperBulletComp.CountCollision = 2;
