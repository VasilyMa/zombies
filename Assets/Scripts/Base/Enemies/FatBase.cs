...
[CreateAssetMenu(fileName = "FatBase", menuName = "Scriptable Objects/FatBase")]
public class FatBase : EnemyBase
{
    public GameObject ExplosionPrefab;

    public float DamageValueExplosion;
    ...
    public override int Init(EcsWorld world, BattleState state, ref SpawnEvent spawnComp)
    {
        ...
        ref var explosionComp = ref world.GetPool<ExplosionComponent>().Add(entity);
        explosionComp.Damage = attackComp.Damage * DamageValueExplosion;
        explosionComp.Radius = RadiusExplosion;
        explosionComp.Multiplier = DamageValueExplosion;
        explosionComp.ExplosionPrefab = ExplosionPrefab;
